...
CREATE TABLE IF NOT EXISTS `filter` (
  ...
  `VLAN_TCI` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `VLAN_TCI_MASK` varchar(6) DEFAULT NULL,
  `ETH_TYPE` varchar(6) DEFAULT NULL,
  `ETH_TYPE_MASK` varchar(6) DEFAULT NULL,
  ...
  `IP_PROTO` varchar(6) DEFAULT NULL,
  ...
  `SRC_PORT_MASK` varchar(6) DEFAULT NULL,
  `DST_PORT` varchar(6) DEFAULT NULL,
  `DST_PORT_MASK` varchar(6) DEFAULT NULL,
