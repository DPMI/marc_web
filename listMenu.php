...
if(mysqli_num_rows($result)>0) {
	...
	print "<th><b><a href=\"listPages.php?SID=$sid&order=string\">String</a></b></th>";
	print "<th><b><a href=\"listPages.php?SID=$sid&order=type\">Type</a></b></th>";
	...
	print "<th><b><a href=\"listPages.php?SID=$sid&order=comment\">Comment</b></th>";
	...
	while($row = mysqli_fetch_array($result)) {
		...
		print 	"<tr bgcolor='$color' ><td>". $row["id"] . "</td><td>". $row["string"] . "</td><td>". $row["type"] ."</td><td>". $row["url"] ."</td>";
		print "<td>". $row["accesslevel"] . "</td><td>". $row["comment"];
		print "</td><td><a href=\"editMenu.php?SID=$sid&ID=" . $row["id"] ." \">EDIT</a></td></tr>\n";
	}
	print "</table>";
} else {
