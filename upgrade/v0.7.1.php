...
while ($row = mysqli_fetch_assoc($result)) {
	...
	mysqli_query("ALTER TABLE $table ADD mode ENUM('AND', 'OR') NOT NULL DEFAULT 'AND'") or die(mysql_error());
}
mysqli_query($Connect, "CREATE TABLE `version` (`num` INT PRIMARY KEY NOT NULL DEFAULT 1)") or die(mysql_error());
mysqli_query($Connect, "INSERT INTO `version` (`num`) VALUES (1)") or die(mysql_error());
