...
<?php } ?>
	...
	<table border="0" cellspacing="1" width="100%">
	  ...
	  <tr><td style="width: 50px;">&nbsp;</td><td class="label" title="Destination address">DESTADDR</td><td><input id="DESTADDR" name="DESTADDR" type="text" size="23" maxlength="23" onchange="filter_clear(this);" value="<?=$filter->DESTADDR?>"/></td><td class="label" title="Destination type">TYPE</td><td colspan="2"><?=select('TYPE', array('File' => 0, 'Ethernet multicast' => 1, 'UDP' => 2, 'TCP' => 3, 'Discard' => 4), array($filter->TYPE))?><p>Note: TCP requires a running TCP consumer!</p></td></tr>
	  <tr><td style="width: 50px;">&nbsp;</td><td class="label" title="Capture length">CAPLEN</td><td colspan="4"><input id="CAPLEN" name="CAPLEN" type="text" size="14" maxlength="4" onchange="filter_clear(this);" value="<?=$filter->CAPLEN?>" /></td></tr>
